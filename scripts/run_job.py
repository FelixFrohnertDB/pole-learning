...
if raw:
    ...
    # Apply variance threshold directly as in original code
...
X_train, X_val, y_train, y_val = train_test_split(
    X_arr, y_arr_regression, random_state=42, test_size=0.2
)
...
output_path = 'features_sorted.npy' if not raw else 'features_sorted_raw.npy'
