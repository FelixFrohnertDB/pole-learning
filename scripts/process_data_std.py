# In contrast to the `process_data.py` script, this script adds stanardization via scoring 
import numpy as np 
import pandas as pd 
...
# Standardization of the y-data
all_y = zscore(all_y, axis=1)
all_y = np.nan_to_num(all_y, nan=0.0)
